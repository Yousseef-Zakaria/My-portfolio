...
import wavesProject from './assets/RTL.png'
...
function App() {
  ...
  const projects = [
    {
      title: '"متاح" – Freelancing & Crafts Website',
    ...
    {
      title: '"Waves" – Kuwaiti Coffee Shop E-Commerce',
      description: 'A professional and localized Shopify store for a Kuwaiti coffee brand targeting users aged 16 to 49. The website offers a clear RTL Arabic user interface, smooth customer journey, and a responsive design for a seamless experience across devices.',
      technologies: ['Shopify', 'Liquid', 'Transcy App', 'HTML', 'CSS'],
      features: ['RTL Arabic layout', 'Custom Dawn theme styling', 'Manual & API payment setup', 'Localized user experience', 'Responsive design'],
      image: wavesProject, 
      link: 'http://www.wavesku.co/', 
      github: null
    },
    {
    ...
    },
    {
      ...
      image: moviesProject,
      link: 'https://yousseef-zakaria.github.io/Movie-web-site/',
      github: ''
    }
  ]
                ...
                <Card className="h-full hover:shadow-lg transition-shadow duration-300">
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2 capitalize">
                      ...
                      <span>{category === 'other' ? 'Technical Skills' : category === 'soft' ? 'Soft Skills' : category}</span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              <Card className="h-full">
                ...
                <CardContent className="space-y-6">
                  <div className="border-l-2 border-primary pl-4">
                    <div className="flex items-center space-x-2 mb-2">
                      <Calendar className="h-4 w-4 text-muted-foreground" />
                      <span className="text-sm text-muted-foreground">Jun 2025 - now</span>
                    </div>
                    <h3 className="text-lg font-semibold">Programming Instructor</h3>
                    <p className="text-muted-foreground mb-2">IT Zone</p>
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>working with university students and fresh grads, helping them build a strong foundation in:</li>
                      <li>•  C++ & OOP</li>
                ...
                <Card className="h-full hover:shadow-lg transition-all duration-300 group overflow-hidden">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-4">
                      ...
                      {project.github &&
                      <Button  variant="secondary" size="sm" className="opacity-0 cursor-pointer group-hover:opacity-100 transition-opacity delay-200">
      ...
      <footer className="py-8 border-t border-border">
        <div className="container mx-auto px-6 text-center">
          <p className="text-muted-foreground">
            Youssef Zakaria. Built with React & Tailwind CSS.
          </p>
        </div>
      </footer>
    </div>
